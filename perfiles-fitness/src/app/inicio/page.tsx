  ...
  return (
    <div className="flex min-h-screen bg-gray-900 text-white">
      ...
      <aside className="w-64 bg-gray-800 p-5 flex flex-col gap-4">
        <h2 className="text-xl font-bold text-green-400">Sistema Perfiles Fitness</h2>
        <nav className="flex flex-col gap-2 mt-4">
          <Link href="/inicio" className="hover:text-green-400 transition-colors">Inicio</Link>
          <Link href="/buscar" className="hover:text-green-400 transition-colors">Buscar</Link>
          <Link href="/mibiblioteca" className="hover:text-green-400 transition-colors">Mi biblioteca</Link>
          <hr className="border-gray-700 my-2" />
          <Link href="/crearlista" className="hover:text-green-400 transition-colors">Crear lista</Link>
          <Link href="/canciones" className="hover:text-green-400 transition-colors">Canciones que te gustan</Link>
        </nav>
      ...
      <main className="flex-1 p-10 flex flex-col items-center justify-center text-center">
        <div className="bg-gradient-to-r from-purple-700 via-purple-900 to-pink-700 p-10 rounded-3xl shadow-2xl w-full max-w-3xl">
          <h1 className="text-4xl font-bold mb-4">
            Bienvenid@ de nuevo <span className="text-green-400">{username}</span> 👋
          </h1>
          <p className="text-lg text-gray-200 leading-relaxed">
            Bienvenido a tu <span className="text-green-400 font-semibold">panel principal</span>. Aquí podrás acceder a tus 
